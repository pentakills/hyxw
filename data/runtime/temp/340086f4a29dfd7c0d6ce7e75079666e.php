<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./application/admin/template/system\web.htm";i:1594257038;s:77:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\public\layout.htm";i:1594257023;s:74:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\system\bar.htm";i:1594257042;s:77:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\public\footer.htm";i:1594257024;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo url('System/web'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="web_status0" class="cb-enable <?php if(!isset($config['web_status']) OR empty($config['web_status'])): ?>selected<?php endif; ?>">开启</label>
                        <label for="web_status1" class="cb-disable <?php if(isset($config['web_status']) AND $config['web_status'] == 1): ?>selected<?php endif; ?>">关闭</label>
