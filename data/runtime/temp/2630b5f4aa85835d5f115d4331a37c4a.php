<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/template/uploadify\upload.htm";i:1594257044;}*/ ?>
<html lang="zh-cn">
<head>
...
<div class="upload-main">
	<div class="upload-main-left">
		<div class="upload-nav">
			<ul>
				<li><a class="upload-nav-active" href="javascript:void(0);" id="upload_tab">本地上传</a></li>
				<li> <a href="javascript:void(0);" onclick="picture_folder(this);" data-url="<?php echo url('Uploadify/picture_folder',['num'=>$info['num'],'input'=>$info['input'],'path'=>$info['path'],'func'=>$info['func']]); ?>">在线管理</a></li>
			</ul>
		</div>
	</div>
