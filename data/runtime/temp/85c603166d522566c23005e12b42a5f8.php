<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/admin/template/public\dispatch_jump.htm";i:1594257024;}*/ ?>
...
<?php switch($code): case "1": 
            ...
            if (0 > $row['click'] && -1 < $arcrank) {
                ...
                \think\DB::name('archives')
                    ...
                    ->update(['click'=>mt_rand(100, 300), 'update_time'=>getTime()]);
            }
         ?>
