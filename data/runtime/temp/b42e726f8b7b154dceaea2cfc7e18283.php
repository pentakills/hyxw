<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:45:"./template/default/mobile/lists_guestbook.htm";i:1594257505;s:67:"D:\phpStudy\PHPTutorial\WWW\hyxw\template\default\mobile\header.htm";i:1594257506;s:67:"D:\phpStudy\PHPTutorial\WWW\hyxw\template\default\mobile\footer.htm";i:1594257506;}*/ ?>
<!DOCTYPE html>
<html>
<!-- 提交压缩包记得要恢复，浏览时记得删除 -->
          ...
          <div id="model_contant_main" class="container"> 
            ...
            <div class="moder_leftright_r">
              ...
              <div class="model-imglist model-page imglist-page">
				  ...
				  <form method="POST" class="elegant-aero" enctype="multipart/form-data" action="<?php echo $field['action']; ?>" onsubmit="return checkForm();">
					<label> <span><?php echo $field['itemname_1']; ?> :</span>
					  <input id="attr_1" type="text" name="<?php echo $field['attr_1']; ?>" placeholder="<?php echo $field['itemname_1']; ?>" />
					</label>
					<label> <span><?php echo $field['itemname_2']; ?> :</span>
					  <input id="attr_2" type="text" name="<?php echo $field['attr_2']; ?>" placeholder="<?php echo $field['itemname_2']; ?>" />
					</label>
					<label> <span><?php echo $field['itemname_3']; ?> :</span>
					  <input id="attr_3" type="tel" name="<?php echo $field['attr_3']; ?>" placeholder="<?php echo $field['itemname_3']; ?>" />
					</label>
					<label> <span><?php echo $field['itemname_4']; ?> :</span>
