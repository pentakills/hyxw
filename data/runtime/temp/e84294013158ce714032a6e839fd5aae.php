<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"./template/default/pc/view_product.htm";i:1594257520;s:63:"D:\phpStudy\PHPTutorial\WWW\hyxw\template\default\pc\header.htm";i:1595388579;s:63:"D:\phpStudy\PHPTutorial\WWW\hyxw\template\default\pc\footer.htm";i:1595388904;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
      ...
      <div class="wrap-content-in w-system w-productcom">
                  ...
                  <div class="imgSlideMain clearfix">
                    ...
                    <div class="navSlideBox">
                      <ul class="navSlide">
                        <ul>
                          <?php if(is_array($eyou['field']['image_list']) || $eyou['field']['image_list'] instanceof \think\Collection || $eyou['field']['image_list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyou['field']['image_list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                          <li class="i_point <?php if($i == '1'): ?>active<?php endif; ?>"><?php echo $i; ?></li>
                          <?php echo isset($field["ey_1563185380"])?$field["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($field["ey_1563185376"]))?$field["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
                        </ul>
                      </ul>
                    </div>
        ...
        setTimeout(function () {
            imgSlideInit('#imgSlide2', 1000)
                ...
                <div class="product-detail-info" style="margin-left: 0;">
                  <div class="product-detail-info-in">
                    <div class="prd_detInfo_con">
                      <div class="product-title" style="text-align: center;">
                        <h2> <?php echo $eyou['field']['title']; ?> </h2>
                      </div>
                      <div class="product-short-sum" style="text-align: center;"><?php echo $eyou['field']['seo_description']; ?></div>
                      <!--<div class="product-grayBox clearfix">
                        <div class="product-prices"> <?php if(is_array($eyou['field']['attr_list']) || $eyou['field']['attr_list'] instanceof \think\Collection || $eyou['field']['attr_list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyou['field']['attr_list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                          <div class="price-sale"> <?php echo $field['attr_name']; ?>： <span class="num"> ￥<span class="bigsize g-promotion"><?php echo $field['attr_value']; ?></span> </span> </div>
                          <?php echo isset($field["ey_1563185380"])?$field["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($field["ey_1563185376"]))?$field["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?> </div>
        ...
        cursor:auto;
                  ...
                  <div class="info_tab">
                    <div class="info_tab_in">
                      <ul class="clearfix">
                        <li class="cur_tab" data-tab="29707"><a href="javascript:void(0)">详细信息</a></li>
                      </ul>
                    </div>
                  </div>
                  <div class="product-descons">
                    <div class="descon_item" id="Tabitem29707">
                      <div class="wp-products-detail-desc" style="padding:0px;"><?php echo $eyou['field']['content']; ?></div>
                      <p><br/>
                      </p>
                    </div>
                  </div>
