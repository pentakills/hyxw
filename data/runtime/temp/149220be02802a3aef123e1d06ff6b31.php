<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/arctype\add.htm";i:1594256997;s:77:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\public\layout.htm";i:1594257023;s:79:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\field\addonitem.htm";i:1594257009;s:77:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\public\footer.htm";i:1594257024;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Arctype/add'); ?>" method="post">
        ...
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <?php echo (isset($ptypename) && ($ptypename !== '')?$ptypename:''); ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <?php endif; ?>
            <input type="hidden" name="parent_id" id="parent_id" value="<?php echo (isset($parent_id) && ($parent_id !== '')?$parent_id:''); ?>" />
            <dl class="row none" id="row_url">
                <dt class="tit">
                    <label for="dirpath">文件保存目录</label>
                </dt>
                <dd class="opt">
                    <input type="text" value="<?php echo $predirpath; ?>" name="dirpath" id="dirpath" class="input-txt" onkeyup="this.value=this.value.replace(/[^0-9a-zA-Z\/-]/g,'');" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^0-9a-zA-Z\/-]/g,''));">&nbsp;<a href="javascript:void(0);" onclick="get_dirpinyin(this);" class="ncap-btn ncap-btn-green">获取拼音</a>
...
<?php if(is_array($addonFieldExtList) || $addonFieldExtList instanceof \think\Collection || $addonFieldExtList instanceof \think\Paginator): $i = 0; $__LIST__ = $addonFieldExtList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(!isset($vo['ifeditable']) || $vo['ifeditable']): switch($vo['dtype']): case "hidden": ?>
        ...
        <div class="ncap-form-default tab_div_2" style="display:none;">
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="is_part1" class="cb-enable">外部链接</label>
                        <label for="is_part0" class="cb-disable selected">内容栏目</label>
