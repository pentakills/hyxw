<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"./application/admin/template/archives\index_archives.htm";i:1594256995;s:77:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\public\layout.htm";i:1594257023;s:81:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\archives\tags_btn.htm";i:1594256995;s:77:"D:\phpStudy\PHPTutorial\WWW\hyxw\application\admin\template\public\footer.htm";i:1594257024;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <?php if($arctype_info['current_channel'] == '4'): ?>
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="">
                                <div class="w180 tc">
                                    <?php if(is_check_access('Archives@edit') == '1'): if(empty($channelRow[$vo['channel']]['ifsystem'])): ?>
                                            <a href="<?php echo url('Custom/edit',array('id'=>$vo['aid'],'typeid'=>\think\Request::instance()->param('typeid'), 'channel'=>$vo['channel'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                        <?php else: ?>
        ...
        <div class="footer-oper">
            ...
            <div class="nav-dropup">
                ...
                <div class="dropdown-menus" style="display:none;">
                    ...
                    <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Archives/del'); ?>" data-deltype="pseudo"><i class="fa fa-close"></i>删除文档</a>
